...
/* ---------- MAIL SEND ---------- */
$mail = new PHPMailer;
$mail->SMTPDebug = 0; // disable stdout spam, we log instead
$mail->isSMTP();
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'tls';
...
write_log("Attempting to send mail to $f_to, subject='$mail->Subject'");

if (!$mail->send()) {
  write_log("ERROR: " . $mail->ErrorInfo);
  echo 'Message could not be sent.<br>';
  echo 'Mailer Error: ' . $mail->ErrorInfo . '<br>';
} else {
  write_log("SUCCESS: Mail sent to $f_to");
