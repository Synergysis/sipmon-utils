...
ini_set('error_log', '/var/log/centreon-notify.log');
...
/* ---------- LOGGING SETUP ---------- */
$logfile = '/var/log/centreon-notify.log';
...
write_log("Script started with args: " . implode(' ', $argv));

include '/usr/share/centreon/www/class/sipmonDBFunc.class.php';
include '/usr/share/centreon/www/class/discovery_backend.php';
...
write_log('EMAIL:: ' . $f_to);
$f_duration = round(((float) array_shift($argv)) / 60, 2);/*11*/
...
$f_service_note = array_shift($argv);  /*27*/
...
$sipmonDB = new sipmonDBFunc();
$device_sipmon = $sipmonDB->get_service_by_name($f_host_address, $f_serv_desc);

if (isset($device_sipmon[0]['service_comment']) && $device_sipmon[0]['service_comment'] !== '') {
  $f_service_note = $device_sipmon[0]['service_comment'];
}
...
<head>
    <meta charset="utf-8">
    <meta name="description" content="SIPMon Email Notification Alert">
                ...
                <tbody>
                  <tr>
                    <td width="98%" style="vertical-align:middle;font-size:14px;width:98%;margin:0 10px 0 10px;">
                      ...
                      <h2 style="font-family: CoconPro-BoldCond, Open Sans, Verdana, sans-serif; margin:0; font-size:26px; text-align:center;">' . $f_serv_desc . '<br>' . $f_service_note . '</h2>
        ...
        <tr>
          <td style="font-family: CoconPro-BoldCond, Open Sans, Verdana, sans-serif; vertical-align:middle; color: #999999; text-align: center; padding: 40px 10px;width: 100%;" class="x-gmail-data-detectors">
            <span style="font-family: CoconPro-BoldCond, Open Sans, Verdana, sans-serif; color:#999999; text-align:center;">
              Copyright &#169; 2014-' . $f_date_year . ' &#124; <a href="info@synergysis.com?subject=SIPMON" style="font-family: CoconPro-BoldCond, Open Sans, Verdana, sans-serif; text-decoration:underline; color:#000000;">SynergySIS</a>
            </span>
            <br>
            <span style="font-family: CoconPro-BoldCond, Open Sans, Verdana, sans-serif; color:#999999; text-align:center;">
              All Rights Reserved.
...
$mail->Port = 587;
$mail->Username = 'sysanosis@gmail.com';
$mail->Password = 'iegl clro axew yhmc';
$mail->From = 'sysanosis@gmail.com';
$mail->FromName = 'SIPMon';
...
$pathToFile = '/var/log/email/mail.log';
if (!$mail->send()) {
